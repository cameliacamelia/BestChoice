...
export class UserRequestComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.userRequestService
            ...
            .subscribe(
                (res: HttpResponse<IUserRequest[]>) => this.paginateUserRequests(res.body, res.headers),
    ...
    registerChangeInUserRequests() {
        this.eventSubscriber = this.eventManager.subscribe('userRequestListModification', response => this.reset());
    }
    ...
    private paginateUserRequests(data: IUserRequest[], headers: HttpHeaders) {
