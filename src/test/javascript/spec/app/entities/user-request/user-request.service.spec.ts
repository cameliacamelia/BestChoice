    ...
    describe('UserRequest Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-requests';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });

            it('should create a UserRequest', () => {
                service.create(new UserRequest(null)).subscribe(received => {
            ...
            it('should update a UserRequest', () => {
                service.update(new UserRequest('123')).subscribe(received => {
            ...
            it('should return a UserRequest', () => {
